...
def tes():
	...
	print("\033[1;97m       ┈╰━━╮"+Fore.RED+"┊▕╱╲▏┊"+Fore.WHITE+"╭━━┴╥╯\033[1;96m["+Back.WHITE+Fore.BLACK+"Copyright By ©Tata ©2022 Tuesday 1 March \033[00m"+Fore.RED+"\033[1;96m]")
	print("")
	print(""+Fore.WHITE+"       Time Local:\033[1;92m"+localtime)
	print(""+Fore.WHITE+"       Youtube:\033[1;92mbit.ly/gak punya YouTube")
	print(""+Fore.WHITE+"       You Ip:\033[1;92m"+IP)
	print(""+Fore.WHITE+"       User:\033[1;92m4590 admin")
	print("")
tes()
